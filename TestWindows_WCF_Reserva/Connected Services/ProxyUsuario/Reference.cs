...
namespace ProxyUsuario
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="UsuarioDC", Namespace="http://schemas.datacontract.org/2004/07/WCF_ReservaYoga")]
    ...
    public interface IServicioUsuario
    {
        ...
        bool InsertarUsuario(ProxyUsuario.UsuarioDC objUsuarioDC);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicioUsuario/InsertarUsuario", ReplyAction="http://tempuri.org/IServicioUsuario/InsertarUsuarioResponse")]
        System.Threading.Tasks.Task<bool> InsertarUsuarioAsync(ProxyUsuario.UsuarioDC objUsuarioDC);
        ...
        bool ActualizarUsuario(ProxyUsuario.UsuarioDC objUsuarioDC);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicioUsuario/ActualizarUsuario", ReplyAction="http://tempuri.org/IServicioUsuario/ActualizarUsuarioResponse")]
        System.Threading.Tasks.Task<bool> ActualizarUsuarioAsync(ProxyUsuario.UsuarioDC objUsuarioDC);
        ...
        ProxyUsuario.UsuarioDC ConsultarUsuario(string strCodigo);
    ...
    public partial class ServicioUsuarioClient : System.ServiceModel.ClientBase<ProxyUsuario.IServicioUsuario>, ProxyUsuario.IServicioUsuario
    {
        ...
        public bool InsertarUsuario(ProxyUsuario.UsuarioDC objUsuarioDC)
        {
            return base.Channel.InsertarUsuario(objUsuarioDC);
        }
        
        public System.Threading.Tasks.Task<bool> InsertarUsuarioAsync(ProxyUsuario.UsuarioDC objUsuarioDC)
        {
            return base.Channel.InsertarUsuarioAsync(objUsuarioDC);
        }
        
        public bool ActualizarUsuario(ProxyUsuario.UsuarioDC objUsuarioDC)
        {
            return base.Channel.ActualizarUsuario(objUsuarioDC);
        }
        
        public System.Threading.Tasks.Task<bool> ActualizarUsuarioAsync(ProxyUsuario.UsuarioDC objUsuarioDC)
        {
            return base.Channel.ActualizarUsuarioAsync(objUsuarioDC);
        }
        
        public ProxyUsuario.UsuarioDC ConsultarUsuario(string strCodigo)
        {
            return base.Channel.ConsultarUsuario(strCodigo);
        }
        
        public System.Threading.Tasks.Task<ProxyUsuario.UsuarioDC> ConsultarUsuarioAsync(string strCodigo)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IServicioUsuario))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:8733/Design_Time_Addresses/WCF_ReservaYoga/ServicioUsuario/");
            }
            throw new System.InvalidOperationException(string.Format("No se pudo encontrar un punto de conexión con el nombre \"{0}\".", endpointConfiguration));
        }
